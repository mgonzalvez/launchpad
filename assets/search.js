...
(function () {
  ...
  // search.js loads, so we can't query it at module scope. Use PNPL.waitFor
  // to wait for the header to appear, then inject the search UI.
  PNPL.waitFor('.site-header .inner', function () {
    initSearch();
  });
